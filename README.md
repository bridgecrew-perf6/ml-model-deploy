...
**UPDATE:** Have added more visualisation in the front-end, including a pie chart and a bar chart 
...
**UPDATE:** In this new version, I have ported the front-end to ReactJS
...
- [] Improve the machine learning model, such as
    ...
    - ~~Use a different metric to measure the performance. Accuracy might not be the best indicator in dataset with highly skewed target class~~ Accuracy works fine in this dataset
